namespace WebAPI
{
    public class EmployeeSQL
    {
        ...
        public static string UpdateEmployeeByIdSQL()
        {
            ...
            string sql = $"CALL Proc_Update_UpdateOneEmployeeById(@EmployeeId, @EmployeeCode,  @FullName, @DepartmentName,  @Gender,  @DateOfBirth,  @Address,  @BankName,  @BankBranch,  @BankAccount,  @Email,  @Mobile,  @LandLinePhone,  @PersonalIdentification,  @PICreatedDate,  @PICreatedPlace,  @PositionName,  @CreatedDate,  @CreatedBy, @ModifiedDate, @ModifiedBy)";
            return sql;
        }
        ...
        public static string CreateOneEmployeeWithDepartmentIdSQL()
        {
            ...
            string sql = $"Call Proc_Create_InsertEmployee(@EmployeeId, @EmployeeCode,  @FullName,  @DepartmentId,  @Gender,  @DateOfBirth,  @Address,  @BankName,  @BankBranch,  @BankAccount,  @Email,  @Mobile,  @LandLinePhone,  @PersonalIdentification,  @PICreatedDate,  @PICreatedPlace,  @PositionName,  @CreatedDate,  @CreatedBy, @ModifiedDate, @ModifiedBy)";
